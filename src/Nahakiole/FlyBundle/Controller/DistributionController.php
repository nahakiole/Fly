...
use Nahakiole\FlyBundle\Form\DistributionType;
...
class DistributionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FlyBundle:Distribution')->findAll();

        return $this->render('FlyBundle:Distribution:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('FlyBundle:Distribution:new.html.twig', array(
            'entity' => $entity,
    ...
    {
        $form = $this->createForm(new DistributionType(), $entity, array(
            'action' => $this->generateUrl('distribution_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FlyBundle:Distribution')->find($id);
        ...
        return $this->render('FlyBundle:Distribution:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('FlyBundle:Distribution:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new DistributionType(), $entity, array(
            'action' => $this->generateUrl('distribution_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('distribution_edit', array('id' => $id)));
        }
    ...
    /**
     * Creates a form to delete a Distribution entity by id.
     *
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('distribution_delete', array('id' => $id)))
            ->setMethod('DELETE')
